function [E_extra,L_inv_cut,U_inv_cut,L_inv_com,U_inv_com,L_k_inv,U_k_inv,T1,H3,total_nodes,total_in,total_boundary,total_no_dup_b,total_no_dup] =Preprocess_overlap (partition_list,nparts,n,A,d,c)
if(~d)
    A=A+A';
else
    A=A';
